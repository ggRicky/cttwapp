...
class AuthItem extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['name', 'type'], 'required'],
            [['type', 'created_at', 'updated_at', 'rule_name', 'data'], 'default', 'value' => null],
            [['type', 'created_at', 'updated_at'], 'integer'],

            // 2018-05-26 : In the next rule, the 'data' field is moved into the above list with default null value.

            [['description'], 'string'],
            [['name', 'rule_name'], 'string', 'max' => 64],
            [['name'], 'unique'],

            // 2018-05-26 : Disabled the next rule to enforce the foreign key constrain in auth_item table.
            // The field 'rule_name' is include in the above list with default null value.
    ...
    public function attributeLabels()
    {
        return [
            ...
            'rule_name' => Yii::t('app', 'Nombre de la Regla'),
