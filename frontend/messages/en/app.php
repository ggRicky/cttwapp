...
return ([
    ...
    'Actualizar' => 'Update',
    'Administrar los tipos de clientes' => 'Manage customer types',
    'Calle' => 'Street',
    'Cliente' => 'Client',
    'Creado en' => 'Created at',
    'Creado por' => 'Created by',
    'Crear' => 'Create',
    str_repeat('&nbsp;',4).'Crear Cliente'.str_repeat('&nbsp;',4) => str_repeat('&nbsp;',4).'New Client'.str_repeat('&nbsp;',4),
    ...
    'Modificar Cliente' => 'Update Client',
    'Modificar Tipo de Cliente' => 'Update Client Type',
    ...
    str_repeat('&nbsp;',0).'Tipos de Clientes'.str_repeat('&nbsp;',0) => str_repeat('&nbsp;',3).'Client Types'.str_repeat('&nbsp;',3),
    ...
    'Artículo' => 'Article',
    'Catálogo' => 'Catalog',
    str_repeat('&nbsp;',2).'Catálogos'.str_repeat('&nbsp;',2) => str_repeat('&nbsp;',2).'Catalogs'.str_repeat('&nbsp;',2),
    ...
    'Marca' => 'Brand',
    str_repeat('&nbsp;',6).'Marcas'.str_repeat('&nbsp;',6) => str_repeat('&nbsp;',4).'Brands'.str_repeat('&nbsp;',4),
    'Modificar Artículo' => 'Update Article',
    'Modificar Catálogo' => 'Update Catalog',
