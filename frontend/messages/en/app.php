...
return ([
    ...
    'Introduzca el número de registros que desea visualizar en el módulo. Por último, al guardar los cambios que realizó, éstos serán aplicados al módulo.' => 'Enter the number of records you want to display in the module. Finally, when saving the changes you made, these will be applied to the module.',
    ...
    'Seleccione y marque las columnas que desea Mostrar o bien Ocultar en este módulo. Por último, al guardar los cambios que realizó, éstos serán aplicados al módulo.' => 'Select and mark the columns that you want to Show or Hide in this module. Finally, when saving the changes you made, these will be applied to the module.',
