...
$this->title = 'Catálogo';
$description = 'Vista del Catálogo';
...
<section id="yii2" class="yii2-page">
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 text-center">
            <?= Html::a(Yii::t('app','R e g r e s a r'), ['catalog/index', 'page' => $ret_page, 'hash' => '0'], ['class' => 'btn btn-dark btn-ctt-fixed-width', 'title' => Yii::t('app', 'Regresar al nivel anterior')]) ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 text-justify yii2-content">
            ...
            <!-- Business logic for view an catalog  -->
