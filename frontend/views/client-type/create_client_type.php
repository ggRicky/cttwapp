...
<section id="yii2" class="yii2-page">
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 text-center">
            <?= Html::a(Yii::t('app','R e g r e s a r'), ['client-type/index', ['#' => 'work-area-index']], ['class' => 'btn btn-dark', 'title' => Yii::t('app', 'Regresar al nivel anterior')]) ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-10 text-info yii2-description">
            <p><?= Yii::t('app','Crear Nuevo Tipo de Cliente'); ?></p>
        </div>
    </div>
