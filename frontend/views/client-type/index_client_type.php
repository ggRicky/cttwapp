...
<section id="yii2" class="yii2-page">
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 text-center">
            <?= Html::a(Yii::t('app','R e g r e s a r'), Url::to(['client/index', 'page' => '1', 'hash' => '0']), ['target' => '_self', 'class' => 'btn btn-dark btn-ctt-fixed-width', 'title' => Yii::t('app', 'Regresar al nivel anterior')]) ?>
        </div>
    </div>
        ...
        <div class="col-lg-12 text-justify yii2-content">
            ...
            <?php if (\Yii::$app->user->can('listClientType')): ?>
                ...
                <?php Pjax::begin(); ?>
                    ...
                    <p>
                        <?= Html::a(Yii::t('app', 'Crear Nuevo Tipo de Cliente'), ['create', 'page'=>$curr_page], ['class' => 'btn btn-success', 'title' => Yii::t('app', 'Crear un nuevo registro de tipo de cliente')]) ?>
                    </p>
            ...
            <div class="panel panel-default">
                ...
                <div id="tools" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <span>
                           <?php
                               echo Html::a('', ['help/view', 'theme' => '_client_type', 'ret_url' => 'client-type/index', 'ret_hash' => '0' ], ['class' => 'btn glyphicon glyphicon-question-sign', 'title' => Yii::t('app', 'Ayuda')]);
