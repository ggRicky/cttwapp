...
<div class="warehouse-form">
    ...
    <!-- 2019-08-04 : If there is an flash message, then display it.-->
    ...
    // 2019-08-04 : Init some model fields to default values if new record.

    if ($model->isNewRecord) {
        $model->desc_warehouse = $model->attendant_warehouse = "N/D";
    }

    ?>

    <?= $form->field($model, 'id')->textInput(['style' => 'text-transform: uppercase', 'maxlength' => true]) ?>
    <?= $form->field($model, 'desc_warehouse')->textInput(['style' => 'text-transform: uppercase', 'maxlength' => true]) ?>
    <?= $form->field($model, 'attendant_warehouse')->textInput(['style' => 'text-transform: uppercase', 'maxlength' => true]) ?>
    ...
    <?php
    // 2019-08-04 : Sends the current page value through a hidden input.
